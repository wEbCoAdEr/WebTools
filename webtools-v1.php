...
if(!empty(API_KEY1)){
    ...
    //Execute IP commands
		...
		echo "In order to use this script please place your valid API key at the top of the code. Otherwise all WebTools features will not work\n";
		}
